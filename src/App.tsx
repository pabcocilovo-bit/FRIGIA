...
const SUPPORT_FAQS = [
  ...
  { q: "La recette ne correspond pas à mes ingrédients ?", a: "Essayez de prendre la photo dans un endroit bien éclairé, avec le frigo bien ouvert. Plus la photo est nette, meilleure est la détection." },
