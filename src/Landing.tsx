...
function Hero({ onOpen, onInstall, installLabel, compact }: { onOpen: () => void; onInstall?: () => void; installLabel?: string; compact?: boolean }) {
  ...
  return (
    <section style={{ minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:compact?"60px 48px 80px":isRegularChrome?"80px 48px 60px":"120px 48px 80px",position:"relative",overflow:"hidden" }}>
      {/* Orbs */}
